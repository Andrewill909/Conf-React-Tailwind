      ...
      <section>
        <div class=" bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div class="border-t border-gray-200">
            <dl>
              <div class="bg-yellow-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">Full name</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Margot Foster</dd>
              </div>
              <div class="bg-yellow-600 flex-stretch px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <div class="bg-pink-400 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">Salary expectation</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">$120,000</dd>
              </div>
              <div class="bg-blue-light px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
